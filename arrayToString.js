// say something with chars in an array
const arrOfChars = ['B', 'e','h', 'i', 'n', 'd', ' ', 'y', 'o', 'u']

// turn that array into string

// meh this includes commas
console.log(arrOfChars.toString())
